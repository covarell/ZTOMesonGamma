...
python plot_histos_bkgEstimation.py 0.000027 1 1 histos/latest_productions/SR_Phi_BDT_Data.root histos/latest_productions/SR_Phi_BDT_Signal.root histos/latest_productions/CR_Phi_BDT_SidebandsNorm.root
