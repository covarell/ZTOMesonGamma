...
python plot_histos_bkgEstimation.py 0.00001 0 1 histos/latest_productions/SR_Phi_preselection_Data.root histos/latest_productions/SR_Phi_preselection_Signal.root histos/latest_productions/CR_Phi_preselection_SidebandsNorm.root
